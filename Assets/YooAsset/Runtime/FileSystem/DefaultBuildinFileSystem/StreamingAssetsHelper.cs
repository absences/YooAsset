...
namespace YooAsset
{
    ...
    {
        [UnityEditor.MenuItem("YooAsset/GenBuildAssetList")]
        public static void GenBuildInAssetList()
        {

            string rootPath = $"{Application.dataPath}/StreamingAssets";
            DirectoryInfo rootDirectory = new DirectoryInfo(rootPath);
            if (rootDirectory.Exists == false)
            {
                throw new System.Exception($"Can not found buildin root folder : {rootPath}");
            }
        ...
        private static void CreateBuildinManifest(string packageName, string pacakgeDirectory)
        {
            // 获取资源清单版本
            ...
            string saveFilePath = $"Assets/Resources/{packageName}/{DefaultBuildinFileSystemDefine.BuildinCatalogFileName}";
